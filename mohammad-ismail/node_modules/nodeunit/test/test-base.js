...
// Are exported test actually run? - store completed test in this variable
// for checking later
var tests_called = {};

// most basic test that should run, the tests_called object is tested
// at the end of this module to ensure the test were actually run by nodeunit
...
// test are async, so wait for them to be called
waitFor(function () {

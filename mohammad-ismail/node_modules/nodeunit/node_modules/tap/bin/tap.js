...
Usage:
    ...
    Run the files as tap test, parse the output, and report the results

Options:

    --stderr    Print standard error output of test to standard error.
    --tap       Print raw tap output.
    --diag      Print diagnostic output for passed test, as well as failed.
                (Implies --tap)
    --gc        Expose the garbage collector to test.
...
// other test that might rely on these

...
// of test for something.  For async stuff, it's generally better,
...
// test marked "todo" can fail without counting against the overall score
// never ever ever write test to "verify" incorrect behavior!
...
test("http server", function (t) {
  ...
  // test, as well as all the parallel test before it.
...
test("meta-test", function (t) {
  ...
  t.test("verifying test success/failure expectations", function (t) {
    t.once("end", function () {
      ...
      is(res.testsTotal, 6, "total test")
      is(res.tests,      2, "should be 2 relevant test")
